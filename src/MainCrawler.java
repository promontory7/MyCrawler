...
public class MainCrawler {
	...
	public static void main(String[] args) {
		...
		// Spider.create(new
		// ZhongshanProcessor()).addUrl(ZhongshanProcessor.url).thread(5).run();
		//
		// Spider.create(new
		// ZhuHaiProcessor()).addUrl(ZhuHaiProcessor.url).thread(5).run();
		//
		// Spider.create(new
		...
		//
		// Spider.create(new
		// Huizhouprocessor()).addUrl(Huizhouprocessor.url).thread(5).run();
		//
		// Spider.create(new
		// YangjiangProcessor()).addUrl(YangjiangProcessor.url).thread(5).run();
		//
		// Spider.create(new
		// MaomingProcessor()).addUrl(MaomingProcessor.url).thread(5).run();
		//
		// Spider.create(new
		// ZhaoqingPrecessor()).addUrl(MaomingProcessor.url).thread(5).run();
		//
		// Spider.create(new
		// QingyuanProcessor()).addUrl(QingyuanProcessor.url).thread(5).run();
		//
		// Spider.create(new
		// jiangmenProcessor()).addUrl(jiangmenProcessor.url).thread(5).run();
		//
		// Spider.create(new
		...
		//
		// Spider.create(new
		// DongguanProcessor()).addUrl(DongguanProcessor.url).thread(5).run();
		//
		// Spider.create(new
		// ChaozhouProcessor()).addUrl(ChaozhouProcessor.url).thread(5).run();
		//
		//
		// Spider.create(new
		// JieyangProcessor()).addUrl(JieyangProcessor.url).thread(5).run();
		//
		...
		Spider.create(new ShundeProcessor()).addUrl(ShundeProcessor.url).addUrl(ShundeProcessor.url)
