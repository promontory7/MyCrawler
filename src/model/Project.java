...
public class Project {
	...
	public String toString() {
		return "Project [id=" + id + ", websiteType=" + websiteType + ", projectName=" + projectName + ", projectNo="
				+ projectNo + ", projectBrief=" + projectBrief + ", projectAddress=" + projectAddress + ", projectType="
				+ projectType + ", projectStage=" + projectStage + ", projectPrice=" + projectPrice + ", tenDerWay="
				+ tenDerWay + ", planCycle=" + planCycle + ", publicStart=" + publicStart + ", publicEnd=" + publicEnd
				+ ", FinalEnd=" + FinalEnd + ", owners=" + owners + ", ownerpeopleName=" + ownerpeopleName
				+ ", ownerpeoplePhone=" + ownerpeoplePhone + ", agency=" + agency + ", agencyName=" + agencyName
				+ ", agecyPhone=" + agecyPhone + ", bond=" + bond + ", bonder=" + bonder + ", isAcceptUnion="
				+ isAcceptUnion + ", qualification_requir=" + qualification_requir + ", manager_require="
				+ manager_require + ", attach=" + attach + ", article=" + article + "]";
	}
